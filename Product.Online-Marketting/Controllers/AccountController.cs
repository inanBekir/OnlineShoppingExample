...
using Product.Online_Marketting.Identity;
using System;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(Register model)
        {
            if (ModelState.IsValid)
            {
             ...
             ApplicationUser user= new ApplicationUser();
                ...
                {
                    ModelState.AddModelError("RegisterUserError", "Error! User has not been created. ");
                }
        ...
        public ActionResult Login(Login model,string ReturnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    // include existing user in the system.
                    // ApplicationCookie will create and leave the system.
                ...
                {
                    ModelState.AddModelError("LoginUserError", "Error! Not exist is user.");
                }
